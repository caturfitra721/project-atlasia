  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.parchment }}>
      <View style={{ paddingHorizontal: spacing.xl, paddingTop: spacing.xl }}>
        ...
        <Text style={{ fontSize: 10, color: colors.goldDeep, marginTop: spacing.lg, marginBottom: spacing.sm }}>
          PERTANYAAN {index + 1} DARI {country.quiz.length}
        </Text>
        <Text style={{ fontSize: 18, fontWeight: '600', color: colors.ink, lineHeight: 26 }}>
          {question.question}
        </Text>
      </View>
