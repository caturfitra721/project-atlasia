...
export type Country = {
  ...
  aboutCulture: string;
  tags: string[];
  flagCode: string; // 2 huruf untuk kotak bendera sederhana
  // posisi pin di atas peta ilustrasi, dalam PERSEN (bukan lintang-bujur asli)
  mapX: number;
  mapY: number;
  quiz: QuizQuestion[];
};
    ...
    quiz: [
      {
        ...
        options: ['Alexandria', 'Giza', 'Luxor', 'Kairo'],
        correctIndex: 3,
      },
    ],
  },
